...
if [[ $version == "ros1" && $release =~ focal ]]; then
	...
	echo "source /opt/ros/noetic/setup.bash" >> /home/topeet/.bashrc
...
if [[ $version == "ros2" && $release =~ focal ]]; then
	...
	echo "source /opt/ros/galactic/setup.bash" >> /home/topeet/.bashrc
...
if [[ $version == "ros2" && $release =~ jammy ]]; then
	...
	echo "source /opt/ros/humble/setup.bash" >> /home/topeet/.bashrc
